...
router.put('/like',requiredLogin, (req,res)=>{
    ...
    },{//If we dont write this MongoDB will turn us an old record and we want a new updated record
        new: true
    }).exec((err, result)=>{
        if(err){
...
router.delete("/deletecomment/:id/:comment_id", requiredLogin, (req, res) => {
    ...
    Post.findByIdAndUpdate(req.params.id,{$pull: { comments: comment }},{new: true})
